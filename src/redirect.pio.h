...
#define gpio_redirect_wrap_target 0
#define gpio_redirect_wrap 1
#define gpio_redirect_pio_version 0

static const uint16_t gpio_redirect_program_instructions[] = {
            //     .wrap_target
    0x30a0, //  0: wait   1 pin, 0        side 0
    0x3820, //  1: wait   0 pin, 0        side 1
            //     .wrap
};

#if !PICO_NO_HARDWARE
static const struct pio_program gpio_redirect_program = {
    .instructions = gpio_redirect_program_instructions,
    .length = 2,
    .origin = -1,
    .pio_version = gpio_redirect_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};

static inline pio_sm_config gpio_redirect_program_get_default_config(uint offset) {
    pio_sm_config c = pio_get_default_sm_config();
    sm_config_set_wrap(&c, offset + gpio_redirect_wrap_target, offset + gpio_redirect_wrap);
